...
-- local function find_icon(path)
--     local gfs = require("gears.filesystem")
--     local themes_path =  gfs.get_themes_dir()
--     string.startswith = function(self, str) return self:find('^' .. str) ~= nil end

--     if not path:startswith("default") then
--         return themes_path .. "default" .. path
--     end
-- end

-- find_icon("layouts/fairhw.png")
...
theme.bg_focus = c.gray3
theme.bg_urgent = "#ff0000"
theme.bg_minimize = c.background
theme.bg_systray = theme.bg_normal
theme.fg_normal = "#353535"
theme.fg_focus = "#ffffff"
theme.fg_urgent = "#eeeeee"

theme.useless_gap = 5
theme.border_width = 2
theme.border_normal = c.foreground
